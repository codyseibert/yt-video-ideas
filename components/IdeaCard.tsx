...
const IdeaCard = ({ idea }: Props) => {
  return (
    <div>
      <div className="m-4 p-4 block max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
